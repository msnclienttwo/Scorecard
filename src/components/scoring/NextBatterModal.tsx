...
interface NextBatterModalProps {
  isOpen: boolean;
  onClose: () => void;
  ...
  title?: string;
  hint?: string;
  onConfirm: (batterId: string) => void;
}

export function NextBatterModal({
  isOpen,
  onClose,
  battingPlayers,
  excludedIds,
  ...
  }, [battingPlayers, excludedIds, dismissedIds, query]);
    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title} size="lg">
      ...
      <div className="max-h-80 space-y-1.5 overflow-y-auto">
        ...
        {eligible.map((p) => (
          ...
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white/10 text-xs font-bold text-white">
