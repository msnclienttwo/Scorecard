    ...
    <motion.div variants={container} initial="hidden" animate="show" className="mx-auto max-w-3xl space-y-6">
        ...
        <motion.div variants={item} className="glass-card rounded-2xl p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted">Matches Scored</p>
            </div>
          </div>
        </motion.div>
        <motion.div variants={item} className="glass-card rounded-2xl p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted">Teams Managed</p>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <motion.div variants={item} className="glass-card rounded-2xl p-6">
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-foreground/80">Profile Image</label>
            <div className="flex items-center gap-4">
              ...
              <button type="button" className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-muted transition-all hover:bg-white/10 hover:text-foreground">
                Upload Image
              </button>
            </div>
          </div>
          <button
            type="submit"
            className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-primary to-accent px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30 hover:brightness-110 active:scale-[0.98]"
          >
